...
4. Install [uv](https://docs.astral.sh/uv/getting-started/installation/) if you haven't already.
5. `pnpm install` to install the required Node dependencies.
6. `uv sync` to create a virtual environment and install Python dependencies.
